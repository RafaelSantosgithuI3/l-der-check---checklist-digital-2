...
import { User, ChecklistData, ChecklistItem, ChecklistLog, MeetingLog, ChecklistEvidence, Permission, LineStopData, ConfigItem } from './types';
import { 
      ...
      return (
          <Layout sidebar={<SidebarContent />}>
              <div className="w-full max-w-7xl mx-auto space-y-6">
                  ...
                  {managementTab === 'MODELS' && renderGenericList('Modelos de Produto', models, setModels, saveModels)}
