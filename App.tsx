...
import { ScrapModule, ScrapTab } from './components/ScrapModule';
...
const App = () => {
    ...
    const [scrapTab, setScrapTab] = useState<ScrapTab>('FORM');
                ...
                <nav className="flex-1 p-4 space-y-1 overflow-y-auto custom-scrollbar">
                    ...
                    {hasPermission('CHECKLIST') && (
                        <>
                            ...
                            <button onClick={() => { setScrapTab('FORM'); setView('SCRAP'); }} className={navItemClass(view === 'SCRAP')}>
        ...
        return (
            <Layout sidebar={<SidebarContent />}>
                ...
                <div className="mb-8 space-y-4">
                    {pendingScrapCount > 0 && (
                        <div
                            className="bg-orange-900/20 border border-orange-500/50 p-4 rounded-xl flex items-center gap-4 animate-pulse cursor-pointer hover:bg-orange-900/30 transition-colors"
                            onClick={() => { setScrapTab('PENDING'); setView('SCRAP'); }}
                        >
                            ...
                            <Button size="sm" onClick={(e) => { e.stopPropagation(); setScrapTab('PENDING'); setView('SCRAP'); }}>Resolver</Button>
                        </div>
                    )}
    ...
    if (view === 'SCRAP') return <Layout sidebar={<SidebarContent />}><ScrapModule currentUser={currentUser!} onBack={() => setView('MENU')} initialTab={scrapTab} /></Layout>;
